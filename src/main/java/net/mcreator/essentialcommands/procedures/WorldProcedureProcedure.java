...
public class WorldProcedureProcedure {
	public static void execute(LevelAccessor world, double x, double z, CommandContext<CommandSourceStack> arguments, Entity entity) {
		if (entity == null)
			return;
		if ((StringArgumentType.getString(arguments, "world")).equals("world")) {
		...
		if ((StringArgumentType.getString(arguments, "world")).equals("overworld")) {
			if (entity instanceof ServerPlayer _player && !_player.level().isClientSide()) {
				ResourceKey<Level> destinationType = Level.OVERWORLD;
				if (_player.level().dimension() == destinationType)
					return;
		...
		if ((StringArgumentType.getString(arguments, "world")).equals("nether")) {
			if (entity instanceof ServerPlayer _player && !_player.level().isClientSide()) {
		...
		if ((StringArgumentType.getString(arguments, "world")).equals("end")) {
			if (entity instanceof ServerPlayer _player && !_player.level().isClientSide()) {
